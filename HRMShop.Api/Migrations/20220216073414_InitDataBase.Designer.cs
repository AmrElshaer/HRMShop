...
namespace HRMShop.Api.Migrations
{
    ...
    [Migration("20220216073414_InitDataBase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMShop.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("HRMShop.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("HRMShop.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HRMShop.Shared.Employee", b =>
                {
                    b.HasOne("HRMShop.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRMShop.Shared.JobCategory", "JobCategory")
                        .WithMany()
